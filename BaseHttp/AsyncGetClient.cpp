...
void AsyncGetClient::handle_resolve(const error_code_type& err,
    ...
    if (!err) {
        ...
        std::cerr << "handle_resolve Error: " << err.message() << std::endl;
    }
}
...
void AsyncGetClient::handle_write_request(const error_code_type& err) {
    if (!err) {
       ...
       std::cerr << "handle_write_request Error: " << err.message() << std::endl;
    }
}
...
void AsyncGetClient::AsyncGetClient::handle_read_status_line(const error_code_type& err) {
    if (!err) {
        ...
        std::cerr << "handle_read_status_line Error: " << err.message() << std::endl;
    }
}
...
//            std::cout << &response_;
        ...
        std::cerr << "handle_read_headers Error: " << err.message() << std::endl;
    }
}
